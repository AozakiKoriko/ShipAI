...
def read_json_data():
    json_file_path = "D:/pyFiles/pythonProject/output.json"
    try:
...
def display_load(lines):
    ...
    def confirm_description():
        ...
        disallowed_exact_words = [" NAN ", " UNUSED ", "NAN", "UNUSED"]
    ...
    def confirm_weight():
        ...
        if weight.isdigit():
            ...
            if 1 <= weight_value <= 999999:
                ...
                messagebox.showerror("Weight Check", "Invalid weight.")
        else:
...
def display_balance(lines):
    ...
    # ... [rest of your existing display_balance function] ...
